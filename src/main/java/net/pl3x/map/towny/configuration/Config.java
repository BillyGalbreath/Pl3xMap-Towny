package net.pl3x.map.towny.configuration;
...
public class Config {
    public static String CONTROL_LABEL = "Towny";
    ...
    public static String CLAIM_TOOLTIP = "<span style=\"font-size:120%;\">{name} ({nation})</span><br />" +
            "Mayor <span style=\"font-weight:bold;\">{mayor}</span><br />" +
            "Assistants <span style=\"font-weight:bold;\">{assistants}</span><br/>" +
            "Residents <span style=\"font-weight:bold;\">{residents}</span><br/>" +
